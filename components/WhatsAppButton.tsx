...
const WhatsAppButton: React.FC = () => {
    ...
    return (
        <a
            ...
            className="fixed bottom-8 right-8 z-50 bg-green-500 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition-transform duration-300 ease-in-out hover:scale-110 animate-fade-in-up"
        >
            <WhatsAppIcon />
        </a>
    );
